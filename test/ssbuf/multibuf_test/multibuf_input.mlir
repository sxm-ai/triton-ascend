  ...
  tt.func public @_attn_fwd(%arg0: !tt.ptr<f16> {tt.divisibility = 16 : i32}, %arg1: !tt.ptr<f16> {tt.divisibility = 16 : i32}, %arg2: !tt.ptr<f16> {tt.divisibility = 16 : i32}, %arg3: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %arg4: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %arg5: !tt.ptr<f16> {tt.divisibility = 16 : i32}, %arg6: !tt.ptr<i32> {tt.divisibility = 16 : i32}) attributes {noinline = false} {
    ...
    scope.scope : () -> () {
      ...
      scf.for %arg7 = %0 to %c131072_i32 step %c28_i32 : i32 {
        ...
        %17:5 = scf.for %arg8 = %c0_i32 to %c8192_i32 step %c64_i32 iter_args(%arg9 = %cst_3, %arg10 = %cst, %arg11 = %cst_2, %arg12 = %12, %arg13 = %14) -> (tensor<64xf32>, tensor<64x128xf32>, tensor<64xf32>, !tt.ptr<tensor<64x128xf16>>, !tt.ptr<tensor<64x128xf16>>)  : i32 {
          ...
          ^bb0(%arg14: f32, %arg15: f32):
            %46 = arith.maximumf %arg14, %arg15 {ssbuffer.end_nesting_depth = 3 : i32, ssbuffer.nesting_depth = 3 : i32} : f32
          ...
          ^bb0(%arg14: f32, %arg15: f32):
            %46 = arith.addf %arg14, %arg15 {ssbuffer.end_nesting_depth = 3 : i32, ssbuffer.nesting_depth = 3 : i32} : f32
            tt.reduce.return %46 {ssbuffer.end_nesting_depth = 3 : i32, ssbuffer.nesting_depth = 3 : i32} : f32
          }) {ssbuffer.end_nesting_depth = 3 : i32, ssbuffer.nesting_depth = 3 : i32, ssbuffer.id=1} : (tensor<64x64xf32>) -> tensor<64xf32>
          ...
          // 依赖%40
          %41 = arith.mulf %arg10, %40 {ssbuffer.end_nesting_depth = 3 : i32, ssbuffer.nesting_depth = 3 : i32, ssbuffer.id=2} : tensor<64x128xf32>
          ...
          scf.yield {ssbuffer.end_nesting_depth = 3 : i32, ssbuffer.nesting_depth = 3 : i32, ssbuffer.id=2} %38, %43, %25, %44, %45 : tensor<64xf32>, tensor<64x128xf32>, tensor<64xf32>, !tt.ptr<tensor<64x128xf16>>, !tt.ptr<tensor<64x128xf16>>
